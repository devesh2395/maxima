        ...
        <div className="flex flex-wrap -m-4">
          <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
            <div className="hover:-translate-y-2 group bg-neutral-50 duration-500 w-44 h-44 flex text-neutral-600 flex-col justify-center items-center relative rounded-xl overflow-hidden shadow-md">
              ...
              <div className="z-20 flex flex-col justify-center items-center">
                <span className="font-bold text-6xl ml-2">99%</span>
          ...
          <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
            <div className="hover:-translate-y-2 group bg-neutral-50 duration-500 w-44 h-44 flex text-neutral-600 flex-col justify-center items-center relative rounded-xl overflow-hidden shadow-md">
              ...
              <div className="z-20 flex flex-col justify-center items-center">
                <span className="font-bold text-6xl ml-2">1K+</span>
                <p className="font-bold">Coustomers</p>
              </div>
            </div>
          </div>
          <div className="lg:w-1/3 lg:mb-0 p-4">
            <div className="hover:-translate-y-2 group bg-neutral-50 duration-500 w-44 h-44 flex text-neutral-600 flex-col justify-center items-center relative rounded-xl overflow-hidden shadow-md">
              ...
              <div className="z-20 flex flex-col justify-center items-center">
                <span className="font-bold text-6xl ml-2">23 Years</span>
